...
#' 
#' @param start_date A POSIXt,Date or string that can be coerced into 
#' Date by \code{\link{as_date}} indicating start of the period of time.
#' 
#' @param end_date A POSIXt,Date or string that can be coerced into 
#' Date by \code{\link{as_date}} indicating end of the period of time.
#' 
#' @param as_percentage A logical scalar. If \code{TRUE} (default) 
#' tracks skipped and time listened to will be a percentage of all tracks and whole time period.
#' 
#'
...
make_summary_dt <- function(streaming_history,
                            start_date,
                            end_date,
                            as_percentage = TRUE) {
