...
#'
#'
#' @param streaming_history_1 A data.table containing streaming history, after 'prepare_streaming_history' was used on it from user 1.
#' @param streaming_history_2 A data.table containing streaming history, after 'prepare_streaming_history' was used on it from user 2.
